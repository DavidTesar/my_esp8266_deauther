...
const char CLI_CHANNELS[] PROGMEM = "channels";               // channels (per-channel packet stats)
const char CLI_CHANNELS_HEADER[] PROGMEM = "Per-channel packet activity (since sniff start):";
...
const char CLI_HELP_CHANNELS[] PROGMEM = "channels";
